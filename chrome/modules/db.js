 ...
 ******************************************************************************/
db.new_brand = function(new_brand_name)
{
    var conn = db.get_conn();
 ...
 * rename a brand
 ******************************************************************************/
db.rename_brand = function(brand_id, new_name)
{
    var conn = db.get_conn();
 ...
 ******************************************************************************/
db.is_brand_in_db = function(brand_name)
{
    var conn = db.get_conn();
 ...
 ******************************************************************************/
db.food_by_id = function(food_id)
{
    var conn = db.get_conn();
    var sql = "SELECT food.brand_id, brand, food_id, name, prot, fat, carb, " +
                "salt FROM food INNER JOIN brands ON food.brand_id = " +
 ...
 ******************************************************************************/
db.is_food_in_db = function(brand_id, food_name)
{
    var conn = db.get_conn();
 ...
 ******************************************************************************/
db.update_food = function(food_id, prot, fat, carb, salt)
{
    //alert('updating');
    var conn = db.get_conn();
 ...
 ******************************************************************************/
db.create_food = function(brand_id, food_name, prot, fat, carb, salt)
{
    //alert('creating');
    var conn = db.get_conn();
 ...
 *  boolean
 ******************************************************************************/
db.is_item_in_diary = function(day_id, item_id)
{
    var conn = db.get_conn();
 ...
 ******************************************************************************/
db.new_diary_item = function(day_id, item_id, amount)
{
    var conn = db.get_conn();
...
db.update_diary_item = function(day_id, item_id, amount)
{
    var conn = db.get_conn();
